...
How many reads were generated per sample in our data? We can use the `summarize_all` function from the dplyr package to determine the number of reads or "depth" per sample.
