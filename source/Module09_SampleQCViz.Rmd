...
* Causes and implications of batch effect or QC issues in an RNA-Seq experiment
...
<**Consider editing to be a single color per group**>
...
PCA plots are also useful for evaluating the impact of "uninteresting" sources of variance, like library preparation or sequencer differences. Evidence of batch effects can sometimes be quite obvious. Let's look at the PCA plot from the DESeq2 vigentte again.
